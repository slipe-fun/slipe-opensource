...
const Post = forwardRef(({ user, setUser, post, isPostDeleted, className}, ref) => {
	
	return (
		<div
		ref={ref}
			className={cn('flex bg-[#161616] w-[calc(200%-2.5rem)] absolute rounded-[2rem] justify-between h-full overflow-hidden items-center flex-col', className)}
		>
