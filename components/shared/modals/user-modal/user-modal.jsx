...
export default function UserModal({ open, setOpen, user }) {
	...
	const { scrollY } = useScroll({ container: profileModalRef, offset: ["40%", "-0%"] });
	...
	return (
		<PageModal className='bg-background' open={open}>
			<div id='profileScrollModal' ref={profileModalRef} className='overflow-y-auto duration-300 ease-out flex flex-col w-full h-full'>
